...
export class ExpedientesController {
  ...
  @Post()
  @Roles('admin', 'eer') //SOLO usuarios con roles "admin" y "eer" pueden CREAR expedientes
  ...
  @Delete(':id')
  @Roles('admin', 'eer') //SOLO usuarios con roles "admin" y "eer" pueden ELIMINAR expedientes
	delete(@Param('id') id: number) {
		return this.expedientesService.delete(id);
  }
  
  @Put(':id')
  @Roles('admin', 'eer', 'secretaria') //SOLO usuarios con roles "admin" y "eer" pueden EDITAR expedientes
